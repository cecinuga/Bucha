...
export default function OperaPage(){
    ...
    return(
        <Parallax pages={5} style={{top: "0", left: "0", background: "radial-gradient(circle, white 0%, black 100%)"}}>
            <ParallaxFotos />
