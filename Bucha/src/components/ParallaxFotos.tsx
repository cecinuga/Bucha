...
export default function ParallaxFotos(){
    ...
    return(
        <>
            ...
            <ParallaxLayer offset={0} factor={2} speed={0}>
                <img style={{display:"inline-block",border:"10px solid #c21839"}} width={xs?"100%":"50%"} height={xs?"50%":"50%"} src={img1}></img>
                <img style={{display:"inline-block",border:"10px solid white"}} width={xs?"100%":"50%"} height={xs?"50%":"50%"} src={img2}></img>
            </ParallaxLayer>
