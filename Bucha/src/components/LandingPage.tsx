    ...
    return(
       <>
         <Group position="center" style={{position:"absolute", bottom:"45%",left:"50%",transform:"translateX(-50%)", zIndex: 1, touchAction: "none"}} display={"inline-block"}>
            <Title order={1} fw={500} mb={xs?10:0} className="font-primary" align="center" style={{whiteSpace:"nowrap"}}>
                Bucha
        ...
        <Group position="center" display={"inline-block"} style={{whiteSpace:"nowrap",position:"absolute", bottom:"10%",left:"50%",transform:"translateX(-50%)", zIndex: 1, touchAction: "none", }} pt={15}>
            <Button3D href="/l-opera" variant="gradient" gradient={{from:"white", to:"red.9"}} style={{marginRight:"0.5rem",display:"inline-block",width:xs?"7rem":"15rem", height:xs?"7rem":"15rem"}}>
                <Title order={xs?5:3} className="font-primary" fw={200}>L'Opera</Title>
            </Button3D>
            <Button3D href="/gli-artisti" variant="gradient" gradient={{from:"black", to:"white"}} style={{marginLeft:"0.5rem",display:"inline-block",width:xs?"7rem":"15rem", height:xs?"7rem":"15rem"}}>
