...
export default function ArtistiPage(){
    ...
    return(
        <Parallax enabled pages={7} style={{top: "0", left: "0", background: "linear-gradient(180deg, rgba(187,61,61,1) 20%, rgba(82,9,25,1) 90%)"}}>
            ...
            <ParallaxLayer factor={xs?2.5:1} style={{paddingTop:"3.5%",background: "linear-gradient(180deg, rgba(145,10,44,1) 20%, rgba(77,11,25,1) 90%)"}} offset={xs?1.50:2} speed={1.2}>
                <Group position="center">
            ...
            <ParallaxLayer factor={xs?2.5:1} style={{paddingTop:"3.5%",background: "linear-gradient(180deg, rgba(145,10,44,1) 20%, rgba(82,9,25,1) 90%)"}} offset={3} speed={1}>
                <Group position="center">
            ...
            <ParallaxLayer factor={xs?2.5:1} style={{paddingTop:"3.5%",background: "linear-gradient(180deg, rgba(145,10,44,1) 20%, rgba(82,9,25,1) 90%)"}} offset={5} speed={1.8}>
                <Group position="center" >
